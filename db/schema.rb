...
ActiveRecord::Schema.define(version: 20150713134911) do
  ...
  add_index "customers", ["gender", "given_name_kana"], name: "index_customers_on_gender_and_given_name_kana", using: :btree
